...
// Ported from the previous vendored FCA to preserve api.httpPostFormData()
// compatibility for scripts/cmds/post.js. Adjusted to use this package's
// logging (log.error) since utils.error does not exist in this FCA build.
